...
import edu.ucsd.xmlrpc.xmlrpc.common.LocalStreamConnection;
 ...
 * similar to the {@link edu.ucsd.xmlrpc.xmlrpc.client.XmlRpcLocalTransport},
...
public class XmlRpcLocalStreamTransport extends XmlRpcStreamTransport {
	...
	protected InputStream getInputStream() throws XmlRpcException {
		localServer.execute(conn.getConfig(), conn.getServerStreamConnection(), null);
