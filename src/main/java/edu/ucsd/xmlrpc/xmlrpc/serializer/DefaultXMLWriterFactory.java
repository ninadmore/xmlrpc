 ...
 * under the License.    
 */
package edu.ucsd.xmlrpc.xmlrpc.serializer;
...
/** The default implementation of {@link edu.ucsd.xmlrpc.xmlrpc.serializer.XmlWriterFactory}
 * tests, whether the {@link edu.ucsd.xmlrpc.xmlrpc.serializer.CharSetXmlWriterFactory}
 * is usable. This is the case, when running in Java 1.4 or later. If so,
 * this factory is used. Otherwise, the
 * {@link edu.ucsd.xmlrpc.xmlrpc.serializer.BaseXmlWriterFactory} is used as a
 * fallback.
 */
